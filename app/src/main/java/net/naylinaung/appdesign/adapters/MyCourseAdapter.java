...
//        }
    ...
    private void bindLoadingMyCourse(final MyCourseViewHolder holder) {
...
//        int currentLikesCount = likesCount.get(holder.getPosition()) + 1;
    ...
    private void updateHeartButton(final MyCourseViewHolder holder, boolean animated) {
        if (animated) {
            if (!likeAnimations.containsKey(holder)) {
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btnComments) {
            ...
            MyCourseViewHolder holder = (MyCourseViewHolder) view.getTag();
            if (!likedPositions.contains(holder.getPosition())) {
        ...
        } else if (viewId == R.id.iv_course_cover_image) {
            MyCourseViewHolder holder = (MyCourseViewHolder) view.getTag();
            if (!likedPositions.contains(holder.getPosition())) {
                likedPositions.add(holder.getPosition());
                updateLikesCounter(holder, true);
