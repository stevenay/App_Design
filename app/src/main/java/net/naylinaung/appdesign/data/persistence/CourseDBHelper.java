package net.naylinaung.appdesign.data.persistence;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import net.naylinaung.appdesign.data.persistence.CoursesContract.CourseEntry;
import net.naylinaung.appdesign.data.persistence.CoursesContract.AuthorEntry;
import net.naylinaung.appdesign.data.persistence.CoursesContract.CourseTagEntry;
import net.naylinaung.appdesign.data.persistence.CoursesContract.CourseCategoryEntry;
import net.naylinaung.appdesign.data.persistence.CoursesContract.ChapterEntry;
import net.naylinaung.appdesign.data.persistence.CoursesContract.TodoListEntry;
import net.naylinaung.appdesign.data.persistence.CoursesContract.TodoItemEntry;
...
public class CourseDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_COURSE_TABLE = "CREATE TABLE " + CourseEntry.TABLE_NAME + " (" +
            ...
            CourseEntry.COLUMN_AUTHOR_ID + " INTEGER NOT NULL, " +
            CourseEntry.COLUMN_CATEGORY_ID + " INTEGER NOT NULL, " +
    ...
    private static final String SQL_CREATE_AUTHOR_TABLE = "CREATE TABLE " + AuthorEntry.TABLE_NAME + " (" +
            ...
            " UNIQUE (" + AuthorEntry.COLUMN_EMAIL + ") ON CONFLICT IGNORE" +
            " );";
    ...
    private static final String SQL_CREATE_CHAPTER_TABLE = "CREATE TABLE " + ChapterEntry.TABLE_NAME + " (" +
            ...
            " UNIQUE (" + ChapterEntry.COLUMN_CHAPTER_NUMBER + ") ON CONFLICT IGNORE" +
            " );";
