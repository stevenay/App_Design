...
import net.naylinaung.appdesign.adapters.CourseTodoAdapter;
import net.naylinaung.appdesign.adapters.TodoAdapter;
import net.naylinaung.appdesign.components.DividerDecoration;
...
public class CourseTodoListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new AnimalsHeadersAdapter(mDataSet);
    ...
    private class AnimalsHeadersAdapter extends CourseTodoAdapter
            implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {

        public AnimalsHeadersAdapter(ArrayList<String> objects) {
            super(objects);
        }
